            ...
            <div class="input-group">
              ...
              <select class="form-control" name="catid">
                <option value='' >全部分类</option>
                  <?php if(is_array($barMenus)): $i = 0; $__LIST__ = $barMenus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$barMenu): $mod = ($i % 2 );++$i;?><option value="<?php echo ($barMenu["menu_id"]); ?>" ><?php echo ($barMenu["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
              </select>
            </div>
          </div>
              ...
              <table class="table table-bordered table-hover singcms-table">
                ...
                <tbody>
                    <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><span class="sing_cursor glyphicon glyphicon-edit" aria-hidden="true" id="singcms-edit" attr-id="<?php echo ($new["news_id"]); ?>" >修改</span>
